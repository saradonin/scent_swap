...
NOTES_LIST = ['Absinth', 'African amber', 'African violet', 'Agarwood', 'Agave', 'Aglaia', 'Aldambre™', 'Aldehydes',
              ...
              'Frangipani', 'Freesia', 'Fruits', 'Fruity notes', 'Gaiac wood', 'Galbanum',
              'Gardenia', 'Gentian', 'Geranium', 'Ginger', 'Ginseng', 'Givaudan', 'Gladiolus', 'Glycyrrhiza',
              'Grain', 'Grapefruit', 'Grasses', 'Green notes', 'Gunpowder', 'Gurjum', 'Hamamelis',
              ...
              'Neroli', 'Neroli', 'Nettle', 'Nutmeg', 'Nuts', 'Oak', 'Oakmoss', 'Oat', 'Okoumé',
              ...
              'Popcorn', 'Poplar', 'Poppy', 'Powdery notes', 'Praliné', 'Primrose', 'Pumpkin', 'Reseda',
              ...
              'Smilax', 'Smoky notes', 'Soapy notes', 'Spearmint', 'Spices', 'Spicy notes', 'Spikenard',
