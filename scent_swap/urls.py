...
from scent_app.views import IndexView, PerfumeListView, BrandListView, BrandAddView, BrandUpdateView, \
    ...
    MessageAddView, MessageListView, MessageDetailsView, MessageRespondView
...
urlpatterns = [
    ...
    path('message/respond/<int:message_id>', MessageRespondView.as_view(), name="message-respond"),
